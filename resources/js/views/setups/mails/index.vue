    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Mail List
                            <router-link to="/home/create-mails" class="btn btn-primary" style="float:right"> Add Mail  </router-link>
                                ...
                                <table class="table datatable dataTable-table">
                                    ...
                                    <tbody>
                                        <tr v-for="(mail,index) in mails" :key="mail.id">
                                            ...
                                            <td>
                                                <router-link :to="{name:'EditMails',params:{id:mail.id}}" class="btn btn-primary"><i class="ri-edit-2-fill"></i></router-link>
                                                <button class="btn btn-danger" @click.prevent="deleteMails(mail.id)"><i class="bi bi-trash-fill"></i></button>
                                            </td>
                                        </tr>
        ...
        deleteMails(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.axios.delete('/api/user/mails/' + id)
                        .then(() => {
