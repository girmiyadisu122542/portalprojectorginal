    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Add Study Level
                            <router-link to="/home/all-study_level" class="btn btn-primary" style="float:right"> All Study Level</router-link>

                        </h5>
                        <form class="row g-3" @submit.prevent="addStudyLevel">
                            <div class="col-md-12">
                                <label for="inputNanme4" class="form-label"> <b>Semister  Name</b> </label>
                                <input type="text" class="form-control" v-model="form.name" placeholder="Enter Study Level name">
...
export default {
    ...
    methods: {
        addStudyLevel() {
            this.axios.post('/api/user/study_levels', this.form)
                .then(({
                    data
                }) => {
