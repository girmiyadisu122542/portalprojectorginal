            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            Add Program
                            <router-link to="/home/all-departements" class="btn btn-primary" style="float: right">
                                All Programs</router-link>
                        </h5>
                        <form class="row g-3" @submit.prevent="editDepartements">
                              <div class="col-md-6">
...
export default {
    ...
    methods: {
        editDepartements() {
             let id =this.$route.params.id;
            this.axios           
                .patch("/api/user/departements/"+ id, this.form)
                .then(({
                    data
                }) => {
